...
def test_read_io_ops():
    ...
    assert fio.read_io_ops(SAMPLE_DATA) == 0.0


def test_write_io_ops():
    """Test write ops parser."""
    assert fio.write_io_ops(SAMPLE_DATA) == 438367.892977


def test_read_bandwidth():
    """Test read bandwidth parser."""
    assert fio.read_bandwidth(SAMPLE_DATA) == 0.0


def test_write_bandwith():
    """Test write bandwidth parser."""
    assert fio.write_bandwidth(SAMPLE_DATA) == 1753471 * 1024
