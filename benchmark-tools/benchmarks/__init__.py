...
def benchmark_metrics(func: types.FunctionType) -> list:
    """Returns the list of available metrics."""
    return [(metric.__name__, metric.__doc__) for metric in getattr(func, BENCHMARK_METRICS)]
...
def benchmark(metrics: list = None, machines: int = 1) -> types.FunctionType:
